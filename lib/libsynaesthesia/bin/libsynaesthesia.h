...
extern __declspec(dllexport) int synaUpload(char* filePath, char* uploadHost);
extern __declspec(dllexport) char* synaCompareChanges(char* remoteHost, char* token);
